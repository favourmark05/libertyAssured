    ...
    <div className="bg-white fixed top-0 left-0 w-full z-[100]">
      <div className="wrap h-20 md:h-[98px] flex flex-row items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <div
            className={`bg-purple-1 h-[44px] w-[108px] md:w-[178px] rounded-xl py-2 px-4 flex items-center justify-center gap-2 transition-all duration-300 ${
              !showTimer ? "blur-sm opacity-60" : ""
            }`}
          >
